...
class CSDT(nn.Module):
    def __init__(self, args, num_classes=11003):
        ...
        self.share_visul_emb_layer = VisualEmbeddingLayer(ratio=args.select_ratio)
        self.share_visul_emb_layer = VisualEmbeddingLayer(ratio=args.select_ratio)
    ...
    def compute_per_loss_ir(self, batch, bound=True):
        ...
        i_tse_f = self.share_visul_emb_layer(image_feats, atten_i, 0)
    ...
    def forward(self, batch):
        ...
        i_tse_f = self.share_visul_emb_layer(image_feats, atten_i)
