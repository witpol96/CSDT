...
class LLCMDataset(BaseDataset):
    dataset_dir = 'ORBench'
    def __init__(self, root='', verbose=True):
        super(LLCMDataset, self).__init__()
        ...
        if verbose:
            self.logger.info("=> LLCM Images and Captions are loaded")
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                ...
                img_path = os.path.join(self.img_dir, anno['file_path'])
